...
public interface XxlJobLogDao {
	...
	public List<XxlJobLog> pageLastList(@Param("jobId") String jobId,@Param("triggerTimeStart") Date triggerTimeStart,@Param("triggerTimeEnd") Date triggerTimeEnd);

	public XxlJobLnLog loadLastStatus(@Param("jobId") int jobId, @Param("triggerTimeStart") Date triggerTimeStart, @Param("triggerTimeEnd") Date triggerTimeEnd);

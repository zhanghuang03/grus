	...
	<div class="content-wrapper">
	    ...
	    <section class="content">
	    	...
	    	<div class="row">
                ...
                <div class="col-xs-2">
                    <div class="input-group">
                        <input type="text" class="form-control" id="jobName" autocomplete="on" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_jobname}" >
                    </div>
                </div>
<#--                <div class="col-xs-2">
                    <div class="input-group">
			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        <input type="hidden" name="glueType" value="GLUE_SHELL" />
<#--
...
<#--                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_childJobId}<font color="black">*</font></label>
                        ...
                        <label for="firstname" class="col-sm-2 control-label">Cron<font color="red">*</font></label>
                        ...
                        <div class="col-sm-4"><input type="text" class="form-control" name="executorFailRetryCount" placeholder="${I18n.jobinfo_field_executorFailRetryCount_placeholder}" maxlength="4"  value="3"></div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="executorTimeout" value="-1" />
...
<#--                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_timeout}<font color="black">*</font></label>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-4"><input type="text" class="form-control" name="author" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_author}" maxlength="50" value="${Request["XXL_JOB_LOGIN_IDENTITY"].username}"></div>
                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_alarmemail}<font color="black">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="alarmEmail" placeholder="${I18n.jobinfo_field_alarmemail_placeholder}" maxlength="100" ></div>
					</div>

                    <div class="form-group">
                        <label for="firstname" class="col-sm-2 control-label">${I18n.jobinfo_field_upStreamJobId}<font color="black">*</font></label>
                        <div class="col-sm-10">
                            <div class="input-group">
                                <textarea class="textarea form-control" readonly="readonly" name="upStreamJobList" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_upStreamJobId}" maxlength="255" style="height: 63px; line-height: 1.2;"></textarea>
                                <span class="input-group-addon popoverDoubleBox" modal="addModal" style="cursor:pointer;" data-original-title="" title=""><i class="glyphicon glyphicon-edit" ></i><span></span></span>
                            </div>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="firstname" class="col-sm-2 control-label">${I18n.jobinfo_field_jobdesc}<font color="black">*</font></label>
                        <div class="col-sm-10">
                            <textarea class="textarea form-control" name="jobDesc" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_jobdesc}" maxlength="255" style="height: 63px; line-height: 1.2;"></textarea>
                        </div>
                    </div>
...
<#--                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_timeout}<font color="black">*</font></label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <textarea class="textarea form-control" readonly="readonly" name="upStreamJobList" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_upStreamJobId}" maxlength="255" style="height: 63px; line-height: 1.2;"></textarea>
                                <span class="input-group-addon popoverDoubleBox" modal="updateModal" style="cursor:pointer;" data-original-title="" title=""><i class="glyphicon glyphicon-edit" ></i><span></span></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="firstname" class="col-sm-2 control-label">${I18n.jobinfo_field_jobdesc}<font color="black">*</font></label>
                        <div class="col-sm-10">
                            <textarea class="textarea form-control" name="jobDesc" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_jobdesc}" maxlength="512" style="height: 63px; line-height: 1.2;"></textarea>
                        </div>
                    </div>
...
<div class="modal fade" id="doubleBox" tabindex="-1" role="dialog"  aria-hidden="false">
    <div class="ue-container">
        ...
        <div style="text-align: right;">
            <button type="submit" class="btn btn-primary flushUpStreaJobListBox" data-dismiss="modal">${I18n.system_ok}</button>
            <button type="button" class="btn btn-primary" data-dismiss="modal">${I18n.system_cancel}</button>
        </div>
    </div>
</div>
...
<script src="${request.contextPath}/static/adminlte/dist/js/cron-selector.js"></script>
...
<script>
    ...
    $("#addModal .form input[name='jobCron']").cronSelector(new Date().getTime(),'jobCron');

    $("#updateModal .form input[name='jobCron']").cronSelector(new Date().getTime(),'jobCron');

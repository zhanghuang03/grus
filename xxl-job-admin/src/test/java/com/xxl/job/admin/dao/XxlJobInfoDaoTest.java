...
public class XxlJobInfoDaoTest {
	...
	public void pageList(){
		List<XxlJobInfo> list = xxlJobInfoDao.pageList(0, 20, null ,0, -1, null, null, null);
		int list_count = xxlJobInfoDao.pageListCount(0, 20, null,0, -1, null, null, null);
	...
	public void save_load(){
		...
		info.setUpStreamJobList("");

//		int count = xxlJobInfoDao.save(info);

		XxlJobInfo info2 = xxlJobInfoDao.loadById(39);
		info.setJobName("test222");
